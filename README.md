...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/linux-perf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/linux-perf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install linux-perf
```
...
It is possible to list all of the versions of `linux-perf` available on your platform:
...
```
pixi search linux-perf --channel conda-forge
```
